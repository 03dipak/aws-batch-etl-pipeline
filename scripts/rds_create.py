...
#get_rds_endpoint("my-rds-mysql-connection")
#print(get_rds_details("my-rds-mysql-connection"))
#delete_rds_instance("my-rds-mysql-connection")

create_rds_instance(db_instance_id="my-rds-mysql-connection", master_username="admin",  master_password="vmsKuOY~nk38|^l#~")
